...
app.post('/signup', async (req, res) => {
  ...
  try {
    ...
    // const hashedPW = password + '_hash';
    const hashedPW = await axios.get(`http://${process.env.AUTH_SERVICE_SERVICE_HOST}/hashed-password/` + password); // k8s provides the env var for each service
